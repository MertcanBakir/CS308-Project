...
public class SalesManagerUpdatesPriceSuccessfully {
    ...
    @Test
    @DisplayName("Sales manager successfully updates product price")
    void salesManagerUpdatesPrice() throws Exception {
        ...
        mockMvc.perform(put("/products/5/update-price") // PATCH -> PUT
                        .header("Authorization", token)
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(body))
                .andExpect(status().isOk())
                .andExpect(content().string(containsString("Product price updated successfully")));
    }
    }
