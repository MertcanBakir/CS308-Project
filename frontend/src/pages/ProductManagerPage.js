...
const ProductManagerPage = () => {
  ...
  const handleNavigateToComments = () => navigate("/product-manager-page/comments");
  ...
  return (
    <div className="productmanager-product-manager-page">
      ...
      <main className="productmanager-manager-container">
        <h2 className="productmanager-dashboard-heading">Product Manager Dashboard</h2>

        <div className="productmanager-manager-buttons">
          <button
